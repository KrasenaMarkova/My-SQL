...
CREATE TABLE students_exams (
    ...
    CONSTRAINT fk__this_student
  	FOREIGN KEY (student_id)
	REFERENCES students(student_id),
    
    CONSTRAINT fk__this_exam
  	FOREIGN KEY (exam_id)
...
CREATE TABLE payments (
	...
	CONSTRAINT fk__payment_student
  	FOREIGN KEY (student_id)
	REFERENCES students(student_id)
);
...
JOIN geography.peaks ON mountains.id = peaks.mountain_id
